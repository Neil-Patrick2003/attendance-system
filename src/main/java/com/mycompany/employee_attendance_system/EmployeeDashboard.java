...
public class EmployeeDashboard extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(LeftPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 179, 600));

        RIghtPanelTabbed.setBackground(new java.awt.Color(204, 204, 204));
        RIghtPanelTabbed.setPreferredSize(new java.awt.Dimension(731, 600));
        RIghtPanelTabbed.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                RIghtPanelTabbedMouseClicked(evt);
            }
        });
        ...
        jPanel21Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel21Layout.createSequentialGroup()
                .addGap(21, 21, 21)
                .addComponent(employeeSummaryLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 632, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        adminReportTabLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, adminReportTabLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(EmployeeFilterComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, 299, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(201, 201, 201))
            .addGroup(adminReportTabLayout.createSequentialGroup()
                .addContainerGap()
        ...
        adminReportTabLayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, adminReportTabLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(adminReportTabLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                ...
                .addGroup(adminReportTabLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, adminReportTabLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        departmentDeleteBtn.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        departmentDeleteBtn.setForeground(new java.awt.Color(255, 255, 255));
        departmentDeleteBtn.setText("Clear");
        ...
        departmentSubmitBtn.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        departmentSubmitBtn.setForeground(new java.awt.Color(255, 255, 255));
        ...
        holidayDatePicker.setBackground(new java.awt.Color(255, 255, 255));
        ...
        jLabel47.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/mycompany/employee_attendance_system/icons/icons8-back-30_1.png"))); // NOI18N
        ...
        getContentPane().add(RIghtPanelTabbed, new org.netbeans.lib.awtextra.AbsoluteConstraints(175, -24, 730, 620));
    ...
    private void LeaveRequestAdminTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_LeaveRequestAdminTableMouseClicked
        ...
        if (leaveRequest.status.toLowerCase().equals("for approval")) {
            LeaveType leaveType = LeaveTypeService.getLeaveTypeByNameWithEmployeeBalance(leaveRequest.employee_id, leaveRequest.leaveType.name);

            message.append("Available Balance: ").append(leaveType.employeeBalance).append("\n");
...
//        timeButton.setEnabled(true);
    ...
    private void departmentDeleteBtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_departmentDeleteBtnMouseClicked
        ...
        departmentSubmitBtn.setText("Create");
        departmentFormLabel.setText("Create");
    ...
    private void DepartmentTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_DepartmentTableMouseClicked
        ...
        if (index >= 0) {
            int departmentId = (int) DepartmentTable.getValueAt(index, 0);

            this.selectedDepartment = DepartmentService.getDepartmentById(departmentId);

            Object[] options = {"Cancel", "Edit"};

            StringBuilder message = new StringBuilder();

            message.append("Update Department");

            int choice = JOptionPane.showOptionDialog(null, message.toString(), "Holiday Details", JOptionPane.YES_NO_CANCEL_OPTION, JOptionPane.QUESTION_MESSAGE, null, options, options[0]);

            if (choice == 1) {
                departmentFormLabel.setText("Update Department");
                departmentSubmitBtn.setText("Update");
                departmentNameTex.setText(this.selectedDepartment.department_name);
            }
        }
    ...
    private void LogoutBtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_LogoutBtnMouseClicked
        ...
        message.append("Are you sure you want to logout.");
        int choice = JOptionPane.showOptionDialog(null, message.toString(), "Logout", JOptionPane.YES_NO_CANCEL_OPTION, JOptionPane.QUESTION_MESSAGE, null, options, options[0]);
    ...
    private void RIghtPanelTabbedMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_RIghtPanelTabbedMouseClicked
        // TODO add your handling code here:
        refreshHolidayTable();
    }//GEN-LAST:event_RIghtPanelTabbedMouseClicked
